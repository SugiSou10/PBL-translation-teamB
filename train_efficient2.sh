...
CUDA_VISIBLE_DEVICES=0,1,2,3 fairseq-train \
		...
		--tensorboard-logdir ../../results/efficient_2/tensorboard \
        --save-dir ../../results/efficient_2/checkpoints/ | tee -a ../../results/efficient_2/train.log