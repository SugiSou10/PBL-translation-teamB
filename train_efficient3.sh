...
mkdir -p ../../results/efficient_3/

CUDA_VISIBLE_DEVICES=0,1,2,3 fairseq-train \
        ../../data/clean250-bin2 \
		--arch transformer \
		--encoder-layers 8 --encoder-embed-dim 512 --encoder-ffn-embed-dim 1024 \
		--decoder-layers 2 --decoder-embed-dim 512 --decoder-ffn-embed-dim 1024 \
		...
		--tensorboard-logdir ../../results/efficient_3/tensorboard \
        --save-dir ../../results/efficient_3/checkpoints/ | tee -a ../../results/efficient_3/train.log